...
```bash
git clone https://github.com/krrishbhandari/SmartAssign.git
cd SmartAssign
```
...
- Multi-model evaluation pipelines for improved reliability
- Instructor-configurable grading rubrics
...
📧 krrishbhandari44@gmail.com

🔗 GitHub: https://github.com/krrishbhandari
