            ...
            <div className="">
              <div className="team-member">
                <div className="member-image">
                  <img src={krish} alt="Krish Bhandari" />
                </div>
                ...
                <p className="member-bio">
                  I am a dedicated student at Vivekanand Education Society Instiute
                  of Technology with a strong passion for Artificial Intelligence
